...
export default function AddToCartButton({ bundle }: AddToCartButtonProps) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* Shopify Pay button */}
      <button className="w-full rounded-full bg-[#5a31f4] py-4 font-normal text-white text-lg hover:bg-[#4a28d4] transition-all flex items-center justify-center gap-2">
        Buy with
      ...
      <button className="text-brand-dark underline text-center pb-[1px]">
