    ...
    <footer className="bg-brand-yellow">
      <div className="mx-auto max-w-[1440px] px-6 py-[36px]">
        ...
        <div className="grid grid-cols-1 text-[20px] sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-10">
          ...
          <div>
            ...
            <ul className="space-y-5 sm:space-y-2">
              <li>
                <Link href="/" className="hover:underline text-[#0d0a0bbf]">
                  Home
                </Link>
              </li>
              <li>
        ...
        <div className="pt-6 flex items-center justify-between">
          <p className="text-[#0d0a0bbf] text-[20px] lg:hidden">
            All rights reserved.
          </p>
          ...
          <div className="flex items-center gap-3 lg:hidden">
            ...
            >
              ...
              />
              <path
                d="M9.63603 22.8114L13.1716 19.2759M9.63603 22.8114H8.22181M9.63603 22.8114V24.2256M19.5355 15.7403L22.3639 18.5688L23.0711 9.37638L13.8787 10.0835L18.1213 14.3261L16 16.4475M16 16.4475H11.7573M16 16.4475L13.1716 19.2759M13.1716 19.2759H8.92892"
                stroke="#FEFEFE"
                strokeWidth="1.5"
                strokeLinecap="round"
              ...
              />
              <path
                d="M14.2322 21.0433L14.2321 24.5788M17.0606 18.2149L17.0606 21.7504"
                stroke="#FEFEFE"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ...
              <circle
                ...
                cy="12.2046"
                r="1"
                transform="rotate(-45 20.2426 12.2046)"
                fill="#FEFEFE"
              />
            </svg>
            <span className="font-bold text-brand-dark text-[20px]">
              Marlene&apos;s
            </span>
          </div>
