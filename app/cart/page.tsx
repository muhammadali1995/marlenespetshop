      ...
      <main>
        ...
        {!isEmpty && (
          <div className="mx-auto max-w-[1500px] px-6">
            ...
            {/* Column headers */}
            <div className="hidden md:grid grid-cols-[80px_1fr_auto_auto] gap-6 pb-4 border-b border-brand-dark/10 text-xs font-normal uppercase text-brand-dark/70 tracking-wide">
            ...
            {/* Cart items */}
            <div className="flex flex-col gap-3 md:gap-0 md:divide-y md:divide-brand-dark/8 border-b border-brand-dark/10 mb-8 pt-4 md:pt-0">
              {items.map((item) => (
            ...
            <div className="ml-auto max-w-[435px] pb-16">
              ...
              <div className="flex items-baseline justify-between mb-2">
                ...
                <p className="font-[Gilroy]" style={{ fontSize: "22.5px", color: "#0D0A0BBF" }}>
              ...
              <Link
                href="/checkout"
                className="flex items-center justify-center w-full rounded-full bg-brand-yellow font-bold text-brand-dark text-base mt-3 hover:brightness-95 transition-all"
                style={{ height: "56.25px" }}
              >
                Checkout
              </Link>
              ...
              <div className="flex gap-3 mt-3">
                <button
                  ...
                  style={{ background: "#5a31f4", height: "42px" }}
                >
